...
<header>
    <div class="header-content">
        <div class="header-content-inner">
            <h1 id="homeHeading">Shanti 2nd Chances</h1>
            <hr>
            <p>Shanti 2nd Chances is a Phoenix-based thrift store with high-quality inventory. Our sales directly benefit those living with and those affected by HIV/AIDS through our parent, Phoenix Shanti Group.</p>
        ...
        <div class="row">
            <div class="col-lg-3 col-md-6 text-center">
                <div class="service-box">
                    ...
                    <p class="text-muted">We're picky so you don't have to be.</p>
                </div>
            </div>
            <div class="col-lg-3 col-md-6 text-center">
                <div class="service-box">
                    ...
                    <h3>We Pick up!</h3>
                    <p class="text-muted">We can pick up at most Valley locations.</p>
                </div>
            </div>
            <div class="col-lg-3 col-md-6 text-center">
                <div class="service-box">
                    ...
                    <h3>New Inventory</h3>
                    <p class="text-muted">We're always getting new items into the store.</p>
                </div>
            </div>
            <div class="col-lg-3 col-md-6 text-center">
                <div class="service-box">
                    ...
                    <p class="text-muted">Get new stuff and help those with HIV/AIDS.</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-6  text-center">
                ...
                <hr class="primary">
                <p>We'd like to hear from you. Please feel free to contact us if you have items to donate or have questions.  Pick-ups must be scheduled by phone.</p>
